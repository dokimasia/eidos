...
func TestScaffold(t *testing.T) {
	...
	t.Run("spells the vocabulary as TypeScript", func(t *testing.T) {
		t.Parallel()
		...
		tests := []struct {
			...
			{
				name: "a declaring assignment destructures with const",
				stmt: emit.Stmt{
			...
			{
				name: "a guard is the truthiness check with its body indented",
				stmt: emit.Stmt{
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				t.Parallel()
				got, err := typescript.Scaffold(tt.stmt, nil)
	...
	t.Run("refuses what TypeScript cannot say", func(t *testing.T) {
		t.Parallel()
		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				t.Parallel()
				_, err := typescript.Scaffold(tt.stmt, nil)
