...
// # Dependency position
//
// core/frontendtest imports core/load, core/plugin, core/store,
// core/node, core/directive, core/meta, core/diag, core/symbol and
// the assert module; it drives the read side end to end, so it
// sits beside core/load at the top and nothing beneath imports it
// back.
